			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form action="{{url('/user-login/')}}" method="post" name="loginForm" id="loginForm">{{ csrf_field() }}
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form action="{{url('/user-register/')}}" method="post" name="registerForm" id="registerForm">{{ csrf_field() }}
