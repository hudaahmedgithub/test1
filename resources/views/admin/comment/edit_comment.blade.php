        ...
        <div class="span12">
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              <form class="form-horizontal" method="post" action="{{url('/admin/edit-comment/'.$comment->id)}}" name="edit_comment" id="edit_comment" novalidate="novalidate">{{ csrf_field() }}
           ...
           <!--   <div class="control-group">
            ...
            -->
                 ...
                 <!--     <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="date" name="date" id="date" value="{{ $comment->date }}" /> 
                </div>
            </div>-->
...
-->
                ...
                <!--  <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="session_id" id="session_id" value="{{ $comment->session_id }}" /> 
                </div>
            </div>-->
